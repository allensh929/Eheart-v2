    ...
    function stateConfig($stateProvider) {
        ...
        .state('department', {
            ...
            data: {
                ...
                pageTitle: 'eheartApp.department.home.title'
            },
            views: {
                'content@': {
        ...
        .state('department-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'eheartApp.department.detail.title'
            },
            views: {
                'content@': {
                    ...
                    resolve: {
                        entity: function () {
                            return {
                                ...
                                description: null,
                                img: null,
                                departmentPlaceholder1: null,
                                departmentPlaceholder2: null,
                                departmentPlaceholder3: null,
                                createdDate: null,
                                createdBy: null,
